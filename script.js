...
(_a = document
    ...
    if (usernameElement && nameElement && emailElement && phoneElement && ProfilePictureInput && educationElement && experienceElement && skillsElement && usernameElement) {
        ...
        var shareableLink_1 = "http://127.0.0.1:5500/?username=".concat(encodeURIComponent(username));
        ...
        var resumeOutput = "\n        <h2>Resume</h2>\n         ".concat(profilePictureURL ? "<img src=\"".concat(profilePictureURL, "\"  alt=\"profile Picture\" class=\"profilePicture\">") : "", "\n        <p><strong>Name:</strong> ").concat(name_1, "</p>\n    <p><strong>Email:</strong> ").concat(email, "</p>\n          <p><strong>Phone:</strong> ").concat(phone, "</p>\n          <h3>Education</h3>\n          <p>").concat(education, "</p>\n          <h3>Experience</h3>\n            <p>").concat(experience, "</p>\n            <h3>Skills</h3>\n            <p>").concat(skills, "</p>\n           <p><strong>Shareable Link:</strong> <a href=\"").concat(shareableLink_1, "\" target=\"_blank\">").concat(shareableLink_1, "</a> </p>\n\n        ");
        ...
        shareLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, navigator.clipboard.writeText(shareableLink_1)];
                    case 1:
                        _a.sent();
